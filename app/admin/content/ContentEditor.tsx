...
const DEFAULTS: Settings = {
  heroHeadline: "Practical technology for real business problems.",
  heroSubheadline: "We help businesses improve websites, workflows, dashboards, and internal tools with practical technology solutions.",
  heroDescription: "$150, book your time, and get a practical improvement roadmap for your business.",
  heroCtaPrimary: "Start With an Assessment",
  heroCtaSecondary: "View Work",
  approachHeading: "Tools that feel clear and useful",
  approachCard1Title: "Clarify",
  approachCard1Body: "Screens that explain what matters",
  approachCard2Title: "Organize",
  approachCard2Body: "Workflows that match the business",
  approachCard3Title: "Maintain",
  approachCard3Body: "Systems that are easier to run",
  capabilitiesTitle: "What We Build",
  cap1Title: "Business Websites",
  cap1Body: "Clear sites that support customer action",
  cap2Title: "Web Applications & Platforms",
  cap2Body: "Custom platforms for real-world use",
  cap3Title: "CRMs & Dashboards",
  cap3Body: "Cleaner records and reporting views",
  cap4Title: "Automation & Integrations",
  cap4Body: "Connected tools and workflow automation",
  fitCtaHeadline: "If this feels useful, we should talk.",
  whoHeadline: "We partner with businesses that need clearer technology",
  ...
  footerTagline: "Practical websites, web apps, dashboards, and workflow tools for businesses that need clearer digital operations.",
};
