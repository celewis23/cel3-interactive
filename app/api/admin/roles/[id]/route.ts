...
export const PATCH = withActivity("/api/admin/roles/[id]", "PATCH", handleActivityPATCH);

export const DELETE = withActivity("/api/admin/roles/[id]", "DELETE", handleActivityDELETE);
