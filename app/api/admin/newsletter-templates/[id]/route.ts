...
export const PATCH = withActivity("/api/admin/newsletter-templates/[id]", "PATCH", handleActivityPATCH);

export const DELETE = withActivity("/api/admin/newsletter-templates/[id]", "DELETE", handleActivityDELETE);
