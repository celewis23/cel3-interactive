...
export const PATCH = withActivity("/api/admin/expenses/categories/[id]", "PATCH", handleActivityPATCH);

export const DELETE = withActivity("/api/admin/expenses/categories/[id]", "DELETE", handleActivityDELETE);
