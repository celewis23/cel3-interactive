...
export const PATCH = withActivity("/api/admin/expenses/[id]", "PATCH", handleActivityPATCH);

export const DELETE = withActivity("/api/admin/expenses/[id]", "DELETE", handleActivityDELETE);
