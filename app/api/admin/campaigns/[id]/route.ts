...
export const PATCH = withActivity("/api/admin/campaigns/[id]", "PATCH", handleActivityPATCH);

export const DELETE = withActivity("/api/admin/campaigns/[id]", "DELETE", handleActivityDELETE);
