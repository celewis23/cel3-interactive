(() => {
  ...
  const base = "/mockups/secret-squares/Home%20%C2%B7%20Client%20landing%20page-html/";
  const concepts = {
    a: { folder: "A · Gig Poster", desktop: "Main.dc.html", mobile: "Mobile.dc.html" },
    b: { folder: "B · The Menu", desktop: "Editorial.dc.html", mobile: "EditorialMobile.dc.html" },
    c: { folder: "C · Kitchen Ticket", desktop: "Ticket.dc.html", mobile: "TicketMobile.dc.html" },
  };
