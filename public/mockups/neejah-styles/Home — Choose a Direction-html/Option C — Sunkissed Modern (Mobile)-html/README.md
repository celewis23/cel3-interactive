# Option C — Sunkissed Modern (Mobile) — design reference
...
- `TicketMobile.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `TicketMobile.dc.html`;
