# Option B — Boutique Classic (Mobile) — design reference
...
- `EditorialMobile.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
`assets/` — 14 in this export — and the exported files refer to them there. A
...
Serve the folder (e.g. `python3 -m http.server`) and open `EditorialMobile.dc.html`;
